...
\begin{aligned}
  ...
  &= 1 + E\Big[\frac{(N+1)(x_i-\overline{x})^2/S-2(1-\frac{1}{N})}{S} \Big] \\
  &= E[(\hat\mu_i^{MLE}-\mu_i)^2] +E\bigg[\frac{(N+1)(x_i-\overline{x})^2/S-2(1-\frac{1}{N})}{S} \bigg]
\end{aligned}
$$  
Hence, 
$$
 E[(\hat \mu_i-\mu_i)^2]-E[(\hat\mu_i^{MLE}-\mu_i)^2] = E\bigg[\frac{(N+1)(x_i-\overline{x})^2/S-2(1-\frac{1}{N})}{S} \bigg]
$$
